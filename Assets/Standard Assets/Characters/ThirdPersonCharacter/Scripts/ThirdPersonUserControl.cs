...
namespace UnityStandardAssets.Characters.ThirdPerson
{
    ...
    public class ThirdPersonUserControl : MonoBehaviour
    {
        ...
        private Vector3 direcao;             // The current forward direction of the camera
        private Vector3 m_Move;
        private bool m_Jump;                      // the world-relative desired move direction, calculated from the camForward and user input.
        float velocidade=200;

        private float x, y; //x e y do joysick visao de cima
        public GameObject JoystickMovimentacaoPersonagem;
        ...
        private void FixedUpdate()
        {
            ...
            if (m_Cam != null)
            {
                ...
                direcao.x = h * velocidade;
                direcao.z = v * velocidade;
            }
            else
            {
                // we use world-relative directions in the case of no main camera
                m_Move = v*Vector3.forward + h*Vector3.up;
            }
#if !MOBILE_INPUT
            ...
            m_Character.Move(direcao, crouch, m_Jump);
            m_Jump = false;
        }
    }
}
